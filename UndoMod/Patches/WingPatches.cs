...
namespace UndoMod
{
    ...
    static class Patch_WAdd { static void Postfix() => SnapHelper.DoStructural(); }

    [HarmonyPatch(typeof(ProcWing2), nameof(ProcWing2.Split))]
    static class Patch_WSplit { static void Postfix() => SnapHelper.DoStructural(); }

    [HarmonyPatch(typeof(ProcWing2), nameof(ProcWing2.ClearWing))]
    static class Patch_WClear { static void Postfix() => SnapHelper.DoStructural(); }

    [HarmonyPatch(typeof(ProcWing2), nameof(ProcWing2.RemoveTrailingEdge))]
    static class Patch_WRemTE { static void Postfix() => SnapHelper.DoStructural(); }

    [HarmonyPatch(typeof(ProcWing2), nameof(ProcWing2.RemoveLeadingEdge))]
    static class Patch_WRemLE { static void Postfix() => SnapHelper.DoStructural(); }

    [HarmonyPatch(typeof(ProcWing2), nameof(ProcWing2.AddStandardLeadingEdge))]
    static class Patch_WAddLE { static void Postfix() => SnapHelper.DoStructural(); }

    [HarmonyPatch(typeof(ProcWing2), nameof(ProcWing2.AddControlSurface))]
    static class Patch_WAddCS { static void Postfix() => SnapHelper.DoStructural(); }

    [HarmonyPatch(typeof(ProcWing2), nameof(ProcWing2.AddFixedTrailingEdge))]
    static class Patch_WAddFTE { static void Postfix() => SnapHelper.DoStructural(); }

    [HarmonyPatch(typeof(ProcWing2), nameof(ProcWing2.AddFowlerFlap))]
    static class Patch_WFowler { static void Postfix() => SnapHelper.DoStructural(); }

    [HarmonyPatch(typeof(ProcWing2), nameof(ProcWing2.AddSplitFlap))]
    static class Patch_WSplitFlap { static void Postfix() => SnapHelper.DoStructural(); }
